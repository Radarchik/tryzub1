 ...
 * @author tszin
 */
public class ServletFromTopicToPost extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletFromTopicToPost</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletFromTopicToPost at suka = " + request.getParameter("topicid") + "</h1>");
            
            String redirectURL = "http://localhost:35700/tryzub/postforumu.jsp";
