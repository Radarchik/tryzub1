...
import uk.tryzub.controllers.PublicationHelper;

@ManagedBean
@ViewScoped
public class PublicationFileUpload implements Serializable {

    private boolean isshowed = true;
    private UploadedFile file;
    private byte[] imageContent;

    @ManagedProperty(value = "#{publicationHelper}")
    ...
    public void save() {
        ...
        Path folder = Paths.get("F:/MyProjects/tryzub/photo/publication");
        ...
        try (InputStream input = file.getInputstream()) {
            ...
            File oldFile = new File("F:/MyProjects/tryzub/photo"+publicationHelper.getSelectedPublication().getPhoto());
            
            /*newFile to be writen in database*/
            publicationHelper.setNewPhoto("/publication/" + newFile.getFileName());
